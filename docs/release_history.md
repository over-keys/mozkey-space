...
Mozkey 4.90.0 / Mozc 3.34 / *2026-09-14*
------------------------------------------

### 4.90.0 の変更内容

- 「Zenz 補正を直接表示」をライブ変換でも使えるようにしました。
...
発行元を確認できないという警告だけが表示された場合は、「詳細情報」→「実行」または「実行する」を選択してインストールを続行してください。
...
User-facing release version: `4.90.0`
Mozc internal version: `3.34.6229.100`
