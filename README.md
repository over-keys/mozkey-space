...
> If macOS refuses to install the PKG, open **System Settings > Privacy & Security**, select **Open Anyway** (or an equivalent control) in the blocked-item notification, and open the PKG again. The package cannot be installed until this approval is granted.
